...
public class Prologue : Story {
    ...
    public void Initial()
    {
        ...
        addConversation(1, "Mari", "Where am I here?", "background", new string[] { "MariV2" }, new Position[] { Position.middle }, null, null);
        addConversation(1, "Mari", "I was tied inside an old dark room", "background", new string[] { "MariV2nottalk" }, new Position[] { Position.middle }, null, null);
        addConversation(1, "Mari", "I look around the room and found my female classmate was tied like me", "background", new string[] { "benz" }, new Position[] { Position.middle }, null, null);
        addConversation(1, "Effect", "**Door open**", "background", new string[] { "benzsmile" }, new Position[] { Position.middle }, null, null);
        addConversation(1, "Mari", "There is horrible man coming and he stare at me", "background", new string[] { "maria" }, new Position[] { Position.middle }, null, null);
